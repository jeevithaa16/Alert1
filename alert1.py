...
headers = {
    "User-Agent": 'Mozill'
                  'a/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36'}
...
def send_mail():
    ...
    body = "Hey Amlan! \n The price of Phillips trimmer on AMAZON has fallen down below Rs." + str(
